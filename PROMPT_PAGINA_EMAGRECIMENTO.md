...
- Priorizar saúde, energia, bem-estar e consistência.
- Incentivar alimentação equilibrada, hidratação, movimento agradável, sono e recuperação.
- Usar linguagem positiva, simples, acolhedora e sem culpa.
- Não prometer resultados rápidos ou milagrosos.
- O conteúdo deve ser educativo e não substituir orientação de profissionais de saúde.

## Evitar
- Contagem de calorias.
- Metas de peso, IMC ou medidas corporais.
- Comparações entre corpos.
- Fotos ou mensagens de antes/depois.
- Dietas extremamente restritivas, jejum ou compensação alimentar.
...
- Fundo muito claro com tonalidade rosada.
- Rosa para ações principais, marca e destaques.
- Azul para títulos, elementos secundários e áreas de contraste.
- Cards com cantos arredondados e sombras suaves.
- Boa hierarquia tipográfica e bastante espaço em branco.
...
5. CTA para começar.
6. Rodapé com aviso educativo.

## Interação
- CTAs devem ter feedback visual claro.
- Menu mobile deve funcionar corretamente.
